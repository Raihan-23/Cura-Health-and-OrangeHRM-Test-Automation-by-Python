...
with sync_playwright() as playwright:
    ...
    #verify url
    assert page.url == "https://katalon-demo-cura.herokuapp.com/#appointment", "Failed to login or incorrect page URL"
...
#verify login
    login_confirmation=page.locator("//h2[@text()='Appointment Confirmation']").text_content()
    assert "Appointment Confirmation" in login_confirmation, "Appointment is not successful"
